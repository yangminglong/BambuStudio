#ifndef slic3r_acparams_panel_hpp_
#define slic3r_acparams_panel_hpp_
...
#define ACTIPS_DIALOG_BUTTON_SIZE wxSize(FromDIP(60), FromDIP(24))
...
class ACTipsDialog : public DPIDialog
{
private:
    bool m_show_again{false};

public:
    ACTipsDialog(wxWindow *parent, const wxString &title);
...
/// Class ACParamsPanel
///////////////////////////////////////////////////////////////////////////////
class ACParamsPanel : public wxPanel
{
#if __WXOSX__
	...
	public:
		ACParamsPanel( wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 1800,1080 ), long style = wxTAB_TRAVERSAL, const wxString& type = wxEmptyString );
		~ACParamsPanel();
